<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Movie1Popup.ascx.vb" Inherits=".Movie1Popup" %>
...
<div style="background-color:#c5dff9; color:Black;">
    ...
    <tr>
        <td><b>
            ...
            <asp:Label ID="Label4" Font-Names="Tahoma" Font-Size="10pt" runat="server"  
                Text=":: Search criteria ::" Font-Bold="true"></asp:Label>
            </b>                                            
                    </td>
    </tr>
    <tr>
        <td valign="top">
            ...
            <asp:Label Font-Bold="true" ID="Label1" Font-Names="Tahoma" Font-Size="9pt" runat="server"  
        ...
        <span style="display:none">
            <asp:Label ID="Label2" Font-Names="Tahoma" Font-Bold="true" Font-Size="9pt" runat="server"  Text="Distibutor:"></asp:Label>
            ...
            <asp:Label ID="Label5" Font-Names="Tahoma" Font-Size="9pt"  Font-Bold="true" runat="server"  
    ...
    <tr>
        <td valign="top" style="text-align: center">
            ...
            &nbsp;<b>Result :  </b>           
            <asp:Label ID="lblResult" runat="server" Font-Bold="true"  ForeColor="#009900" 
    ...
    <asp:GridView ID="GridView1" 
        ...
        GridLines="None" Width="500" AllowPaging="True">
            ...
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False"  Font-Bold="true" CommandName="Select" Font-Size="12px"
