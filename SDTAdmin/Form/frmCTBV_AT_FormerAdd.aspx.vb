            ...
            If Not IsPostBack Then
                ...
                Else
                    ...
                    If dataReader.Read = True Then
                        ...
                        strSQL += vbNewLine + " cl.Former_level_flag, convert(varchar(20), cp.checker_level_id) + 'A' + convert(varchar(20),cp.screen_id) as Former_Wage_id"
                        strSQL += vbNewLine + " FROM tblChecker_Former_Wage cp"
                        strSQL += vbNewLine + " Left join tblChecker_Level cl"
                        strSQL += vbNewLine + " ON cp.checker_level_id = cl.checker_level_id"
                        strSQL += vbNewLine + " WHERE cl.Former_level_flag = 'Y' AND cp.checker_level_id = " + ViewState("LevelID").ToString()

                        sqlFormer.SelectCommand = strSQL
                        GridView1.DataSourceID = "sqlFormer"

                        txtName.Text = ""
                        ddlFormer.SelectedValue = levelId.ToString()
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Try
            ...
            ElseIf e.CommandName = "Del" Then
                ...
                strSQLrefresh += vbNewLine + " cl.Former_level_flag, convert(varchar(20), cp.checker_level_id) + 'A' + convert(varchar(20),cp.screen_id) as Former_Wage_id"
                strSQLrefresh += vbNewLine + " FROM tblChecker_Former_Wage cp"
                strSQLrefresh += vbNewLine + " Left join tblChecker_Level cl"
                strSQLrefresh += vbNewLine + " ON cp.checker_level_id = cl.checker_level_id"
                strSQLrefresh += vbNewLine + " WHERE cl.Former_level_flag = 'Y' AND cp.checker_level_id = " + ViewState("LevelID").ToString()

                sqlFormer.SelectCommand = strSQLrefresh
                GridView1.DataSourceID = "sqlFormer"

                txtName.Text = ""
                ddlFormer.SelectedValue = ViewState("LevelID").ToString()
                ddlFormer.Enabled = False
                ddlScreen.SelectedIndex = 0
            End If
        Catch ex As Exception
        ...
        Try
            ...
            Else
                If ViewState("checkMode") = "ADD" Then
                    ...
                    ViewState("LevelID") = ddlFormer.SelectedValue
