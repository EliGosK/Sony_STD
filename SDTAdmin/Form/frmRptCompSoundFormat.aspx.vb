...
Partial Public Class frmRptCompSoundFormat
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmit.Click
        Try
            ...
            If ddlStatus0.SelectedValue = "Date" Then
                Response.Redirect("frmRptCompSoundFormat_sd.aspx")
            ElseIf ddlStatus0.SelectedValue = "Theater" Then
                Response.Redirect("frmRptCompSoundFormat_st.aspx")
            End If
