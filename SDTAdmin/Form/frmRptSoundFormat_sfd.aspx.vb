...
Partial Public Class frmRptSoundFormat_sfd
    ...
    Private Const PIVOT_WIDTH_HEADER_0 As Integer = 260
    ...
    Protected Sub btnExport0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport0.Click
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=DateAndSoundFormat.xls")
        Response.Charset = ""
