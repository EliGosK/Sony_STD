...
Partial Public Class frmRptMarketSare
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim readBoxOfficeData As IDataReader = getBoxOfficeData.getBoxOfficeSharing(Session("msRptMovieID"), Format(Session("msRptStrDate"), "yyyyMMdd"), Format(Session("msRptEndDate"), "yyyyMMdd"), "BKK")
        Dim readBoxOfficeTotal As IDataReader = getBoxOfficeData.getBoxOfficeSharing(Session("msRptMovieID"), Format(Session("msRptStrDate"), "yyyyMMdd"), Format(Session("msRptEndDate"), "yyyyMMdd"), "Total")
        ...
        While (readBoxOfficeData.Read())
            ...
            detailsRow.Cells(1).Text = readBoxOfficeData("theater_name")
            detailsRow.Cells.Add(New TableCell)
        ...
        cmHeaderRow.Cells(6).ColumnSpan = 2
        cmHeaderRow.Cells(6).Text = "B.O. GROSS"
        cmHeaderRow.Cells(6).Visible = False
        tbl.Rows.Add(cmHeaderRow)
        Dim cmHeaderRowPer As New TableRow()
        cmHeaderRowPer.ForeColor = Color.FromName("#FFFFFF")
        ...
        Dim readBoxOfficeDataCM As IDataReader = getBoxOfficeDataCM.getBoxOfficeSharing(Session("msRptMovieID"), Format(Session("msRptStrDate"), "yyyyMMdd"), Format(Session("msRptEndDate"), "yyyyMMdd"), "CM")
        ...
        While (readBoxOfficeDataCM.Read())
            ...
            detailRowCm.Cells.Add(New TableCell)
            detailRowCm.Cells(1).Text = readBoxOfficeDataCM("theater_name")
        ...
        'totalRowCm.BackColor = Color.FromName("#5D7B9D")
        ...
        readBoxOfficeData = getBoxOfficeData.getBoxOfficeSharing(Session("msRptMovieID"), Format(Session("msRptStrDate"), "yyyyMMdd"), Format(Session("msRptEndDate"), "yyyyMMdd"), "CITY")
    ...
    Protected Sub btnExport0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport0.Click
        Response.Clear()
        Response.AddHeader("content-disposition", "attachment;filename=" & "Market_Share.xls")
