...
Partial Public Class frmRptMarketSareByPeriodStudioOnlyCircuitTheatre
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If (Convert.ToString(Session("msRptDateType")) = "1") Then
                ...
                wkSQL = "SELECT DISTINCT circuit_id, circuit_name, "
                wkSQL += vbNewLine + " studio_name, studio_id,"
                wkSQL += vbNewLine + " theater_name,theater_id,"
                ...
                wkSQL += vbNewLine + " (isnull(tblTheater_11.Theater_name,'') + '' + isnull(tblTheater_21.Theater_name,'')) as Theater_name, "
                ...
                wkSQL += vbNewLine + " left join tblTheater AS tblTheater_15 ON tblRevenue_1.theater_id = tblTheater_15.theater_id"
                wkSQL += vbNewLine + " left join tblTheater AS tblTheater_25 ON tblCompRevenue_1.theater_id = tblTheater_25.theater_id"
                ...
                wkSQL += vbNewLine + " left join tblTheater AS tblTheater_14 ON tblRevenue_2.theater_id = tblTheater_14.theater_id"
                wkSQL += vbNewLine + " left join tblTheater AS tblTheater_24 ON tblCompRevenue_2.theater_id = tblTheater_24.theater_id"
                ...
                wkSQL += vbNewLine + " ) as PercentByKeyCity1,"
                ...
                wkSQL += vbNewLine + " GROUP BY  tblStudio_11.studio_id, tblStudio_11.studio_name, tblMovie_11.studio_id, tblCircuit_11.circuit_id, "
                wkSQL += vbNewLine + " tblCircuit_21.circuit_id,tblCircuit_11.circuit_name,tblCircuit_21.circuit_name,"
                wkSQL += vbNewLine + " tblTheater_11.theater_id,tblTheater_21.theater_id, tblTheater_11.theater_name, tblTheater_21.theater_name"
                wkSQL += vbNewLine + " ) cir"
                wkSQL += vbNewLine + " group by cir.studio_id, cir.studio_name, cir.circuit_id, cir.circuit_name, cir.theater_id, cir.theater_name" ',cir.movie_strdate
                wkSQL += vbNewLine + " order by cir.studio_name, cir.theater_name"


                wkSQLCM = "SELECT DISTINCT circuit_id, circuit_name, "
                wkSQLCM += vbNewLine + " studio_name, studio_id,"
                wkSQLCM += vbNewLine + " theater_name,theater_id,"
                ...
                wkSQLCM += vbNewLine + " (isnull(tblTheater_11.Theater_id,'') + '' + isnull(tblTheater_21.Theater_id,'')) as Theater_id, "
                wkSQLCM += vbNewLine + " (isnull(tblTheater_11.Theater_name,'') + '' + isnull(tblTheater_21.Theater_name,'')) as Theater_name, "
                ...
                wkSQLCM += vbNewLine + " left join tblTheater AS tblTheater_15 ON tblRevenue_1.theater_id = tblTheater_15.theater_id"
                wkSQLCM += vbNewLine + " left join tblTheater AS tblTheater_25 ON tblCompRevenue_1.theater_id = tblTheater_25.theater_id"
                ...
                wkSQLCM += vbNewLine + " left join tblTheater AS tblTheater_14 ON tblRevenue_2.theater_id = tblTheater_14.theater_id"
                wkSQLCM += vbNewLine + " left join tblTheater AS tblTheater_24 ON tblCompRevenue_2.theater_id = tblTheater_24.theater_id"
                ...
                wkSQLCM += vbNewLine + " ) as PercentByKeyCity1,"
                ...
                wkSQLCM += vbNewLine + " GROUP BY  tblStudio_11.studio_id, tblStudio_11.studio_name, tblMovie_11.studio_id, tblCircuit_11.circuit_id, "
                wkSQLCM += vbNewLine + " tblCircuit_21.circuit_id,tblCircuit_11.circuit_name,tblCircuit_21.circuit_name,"
                wkSQLCM += vbNewLine + " tblTheater_11.theater_id,tblTheater_21.theater_id, tblTheater_11.theater_name, tblTheater_21.theater_name"
                wkSQLCM += vbNewLine + " ) cir"
                wkSQLCM += vbNewLine + " group by cir.studio_id, cir.studio_name, cir.circuit_id, cir.circuit_name, cir.theater_id, cir.theater_name" ',cir.movie_strdate
                wkSQLCM += vbNewLine + " order by cir.studio_name, cir.theater_name"
            Else
                ...
                wkSQL += vbNewLine + " tblTheater_11.theater_id,tblTheater_21.theater_id, tblTheater_11.theater_name, tblTheater_21.theater_name"
                wkSQL += vbNewLine + " ) cir"
                wkSQL += vbNewLine + "  group by studio_id, studio_name, circuit_name, circuit_id, theater_name,theater_id"
                wkSQL += vbNewLine + " order by studio_name, Theater_name"
                ...
                wkSQLCM += vbNewLine + " tblTheater_11.theater_id,tblTheater_21.theater_id, tblTheater_11.theater_name, tblTheater_21.theater_name"
                wkSQLCM += vbNewLine + " ) cir"
                wkSQLCM += vbNewLine + "  group by studio_id, studio_name, circuit_name, circuit_id, theater_name,theater_id"
                wkSQLCM += vbNewLine + " order by studio_name, Theater_name"
            ...
            tblFootCM.Rows(0).Cells(4).Text = sumATPCM.ToString("#,##0.00") + " %"
            ...
            'tblFootCM.Rows(1).Cells(4).Text = (sumPerceent + sumPerceentCM).ToString("#,##0.00") + " %"
            tblFootCM.Rows(1).Cells(4).Text = (sumATP + sumATPCM).ToString("#,##0.00") + " %"
