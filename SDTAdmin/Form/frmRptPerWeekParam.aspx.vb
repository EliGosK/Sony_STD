...
Partial Public Class frmRptPerWeekParam
    ...
    '                Session("wRptStrDate") = clnDateFrom.SelectedDate
    '                Session("wRptEndDate") = clnDateFrom.SelectedDate.AddDays(+6)
    '                Session("wRptMovieID") = Movie1Popup1.MovieId
    '                Session("wRptMovieName") = dataReader("movie_nameen")
    '            End If
    '            dataReader.Close()
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        If Me.Movie1Popup1.MovieId <> 0 Then
            ...
            If dataReader.Read = True Then
                ...
                Session("wRptMovieID") = Me.Movie1Popup1.MovieId
                Session("wRptMovieName") = dataReader("movie_nameen")
            End If
            dataReader.Close()
        End If
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmit.Click
        Me.dtpEndDate.SelectedDate = CDate(Me.dtpStartDate.SelectedDate).AddDays(+6)
        Session("wRptStrDate") = Me.dtpStartDate.SelectedDate
        Session("wRptEndDate") = CDate(Me.dtpStartDate.SelectedDate).AddDays(+6) 'Me.dtpEndDate.SelectedDate
        Response.Redirect("frmRptPerWeek.aspx")
    End Sub
    ...
    'Protected Sub clnDateTo_SelectionChanged(ByVal sender As Object, ByVal e As EventArgs) Handles clnDateTo.SelectionChanged
    '    lblDate0.Text = Format(clnDateTo.SelectedDate, "ddd dd-MMM-yyyy")
