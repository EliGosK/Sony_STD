<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="TrailerCollectionFinder.ascx.vb"
    Inherits="SDT.UserControls.TrailerCollectionFinder" %>
<style type="text/css">
    .style1
    {
        font-size: small;
...
<img id="btnFind<%=ClientID%>" src="../images/search1.png"
    width="10px" style="cursor: hand; vertical-align: middle" onclick="btnFind<%=ClientID%>Click()" /><asp:TextBox
        ...
        ForeColor="#666666" Font-Size="8pt"></asp:TextBox><%--display:none;--%>
                ...
                <td align="center">
                    <font face="Tahoma" color="rosybrown" size="1">
                        <asp:GridView ID="grdResult" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            CellPadding="4" DataKeyNames="collection_no" Font-Names="Tahoma" Font-Size="7pt"
                            ForeColor="#333333" GridLines="None" Width="210">
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Select"
                                            Text="เลือก" CommandArgument='<%# Bind("collection_no") %>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Collection_Name" HeaderText="ชุด" ItemStyle-HorizontalAlign="Left"
                                    ItemStyle-VerticalAlign="Middle" SortExpression="Collection_Name" ItemStyle-Width="28px" />
